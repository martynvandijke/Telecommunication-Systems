...
#route B0->C->A2
ip route add 10.0.4.2 via 10.0.2.2 dev eth0
#route B0->C->A1
ip route add 10.0.7.2 via 10.0.2.2 dev eth0
#route B0->C->A3
ip route add 10.0.5.2 via 10.0.2.2 dev eth0
...
#route B1->A0->E1
ip route add 10.0.6.2 via 10.0.1.1 dev eth1
